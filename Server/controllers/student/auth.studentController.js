...
module.exports.signIn = async (req, res) => {
    ...
    try {
        const student = await StudentModel.login(email, password); //On check dans la db si cet utilisateur existe (voir student.model.js=>studentSchema.statics.login (ligne 100)), on le recupère et on stocke tt dans user
